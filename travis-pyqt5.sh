...
# sudo apt-get -qq install qtdeclarative5-dev qt5-default
...
# cd PyQt5_gpl-5.7
# python configure.py --confirm-license --qmake /usr/lib/x86_64-linux-gnu/qt5/bin/qmake  --sip-incdir ../sip-4.18.1/siplib
# make
# sudo make install